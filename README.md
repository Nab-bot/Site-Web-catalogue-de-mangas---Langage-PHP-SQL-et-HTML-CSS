...
fonction/                //Répertoire contenant le fichier php des fonctions
  fonctions.php          // Fonctions PHP (requêtes SQL, utilitaires)
parametrage/             //Répertoire contenant le fichier php param.php
  param.php              // Paramètres de connexion à la base de données 
images/                  // Images utilisées par le site
document/                //Répertoire contenant le script de la base de données
...
-Créer le fichier param.php à la racine du projet :
